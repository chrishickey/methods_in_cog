...
class BAM(object):
    ...
    def __mult_mat_vec(self, vec):
        ...
        try:
            ...
            v_res = [0] * self.len_y
            for x in range(self.len_y):
                for y in range(self.len_x):
                    v_res[x] += vec[y] * array(self.M).transpose()[y][x]
        return v_res
...
if __name__ == "__main__":
    ...
    print('\n')
    print('[1, 0, 1, 0, 1, 0] ---> ', b.get_assoc([1, 1, 0, 0]))
    print('[1, 1, 1, 0, 0, 0] ---> ', b.get_assoc([1, 0, 1, 0]))
